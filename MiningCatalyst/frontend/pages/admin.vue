<template>
  <div class="admin-root">
    <portal to="navbar">
      <portal-nav :items="admin_tabs" @change="changeTab" />
    </portal>

    <!-- ADMIN TAB -->
    <v-card v-if="active_tab == 0" class="table-wrapper" outlined>
    ...
    <!-- SUPER ADMIN TAB -->
    <div style="width: 100%">
      <v-expansion-panels v-if="active_tab == 1" accordion mandatory>
        <v-expansion-panel>
...
import PortalNav from '@/components/navigation/PortalNav.vue'
import Settings from '@/components/admin/Settings.vue'
import EnumEditor from '@/components/admin/EnumEditor.vue'
