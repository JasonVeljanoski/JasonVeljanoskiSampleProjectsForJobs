<template>
  <v-card class="flex-card" outlined>
    <v-card-title class="header">
      ...
      <v-menu :close-on-content-click="false" offset-y>
        <template #activator="{ on }">
          <e-icon-btn tooltip="Headers" v-on="on"> mdi-format-list-checkbox </e-icon-btn>
        </template>
        ...
        <v-card min-width="320">
          ...
          <span class="body-wrapper">
            <draggable :list="headers" dense tag="v-list" v-bind="drag_options">
              <v-card v-for="header in headers">
...
import FilterCard from '@/components/FilterTable/FilterCard.vue'
import FilterPreviewCard from '@/components/FilterTable/FilterPreviewCard.vue'
